    ...
    class Program
    {
        ...
        static void Maze(char[,]maze)
        {
          ...
          static  void ReadMazeFromFile(char[,] maze)
            {
           string path = "D:\\oopweek01lab\\gameProjectInCSharp\\gameMaze.txt";
        ...
        {
            string path = "D:\\oopweek01lab\\gameProjectInCSharp\\game.txt";
        ...
        //static void MoveBulletSpiko(ref bool isBulletActivespiko, ref int spikoBulletx,  ref int  spikoBullety, ref int  spikoBulletCount)
        //{
